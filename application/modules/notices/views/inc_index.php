<div class="corner" id="boxnotice">
	...
	<div class="box <?php echo alternator('','alt')?>"> 
		<a class="thumb" href="notices/view/<?php echo $notice->id ?>"><img width="77" height="64" src="<?php echo (is_file('uploads/notice/thumbnail/'.$notice->image))?'uploads/notice/thumbnail/'.$notice->image:'themes/thaigcd/photo/nophoto.gif' ?>"></a>
		<div class="box_info">
