<div id="boxprnews" class="corner">
	...
	<div id="tabs">
		...
		<div id="tabs-<?php echo $key + 1?>">
			<?php foreach(lang_filter($category->information->where("start_date <= date(sysdate()) and (end_date >= date(sysdate()) or end_date = date('0000-00-00')) and status = 'approve'"))->order_by('stick desc, start_date desc, id desc')->limit(25)->get() as $information ): ?>
			...
			<?php endforeach; ?>
		<br><br>
		<a href="informations/index/<?php echo $category->id?>" class="more-rb" style="margin-top:15px;">more</a>
		</div>
		<?php endforeach; ?>
	</div><!--tabs-->
