<ul class="menu">
	...
	<li><a href="executives/admin/histories">เกี่ยวกับผู้บริการ</a></li>
	...
	<?php if(is_publish('registers')): ?><li <?php echo menu_active('registers','registers')?>><a href="registers/admin/registers">ใบสมัครศูนย์เด็กเล็กปลอดโรค</a></li><?php endif; ?>
	<?php if(is_publish('english_zones')): ?><li <?php echo menu_active('english_zones','english_zones')?>><a href="english_zones/admin/english_zones">English Zone</a></li><?php endif; ?>
</ul>