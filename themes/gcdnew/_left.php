<?php echo modules::run('executives/inc_home'); ?> 
		<div class="paddtop20bot20"><span></span></div>
        
    	<div id="boxtopstory" class="corner">
            <div class="topic"><img src="<?php echo topic("topic_topstory.png") ?>" alt="เรื่องเด่น ประเด็นร้อน" /></div>
            <h3 class="t_topstory"><span></span></h3>
            <div id="topstory">
            		<?php echo modules::run('menus/inc_left'); ?>
                    <!-- <div id="icon"><a href="https://twitter.com/gcdmoph" target="_blank"><img src="themes/gcdnew/images/ico_twitter.gif" alt="go to twitter" width="16" height="16" /></a>&nbsp; <a href="https://www.facebook.com/tmanwg" target="_blank"><img src="themes/gcdnew/images/ico_facebook.png" alt="go to facebook" width="14" height="14" /></a></div> -->
            </div><!--topstory-->
            <h3 class="b_topstory"><span></span></h3>
        ...
        <div class="paddtop20bot20"><span></span></div>
     	...
     	<?php echo modules::run('knowledges/inc_left'); ?>
        <div class="paddtop20bot20"><span></span></div>
        
     	<?php echo modules::run('newsletters/inc_newsletter'); ?>
