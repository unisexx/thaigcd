...
<div id="menu">
	...
	<ul id="drop-nav">
	  ...
	  <li><a target="_self" href="groups"><?php echo lang('structures')?></a>
	    <ul>
	      <li><a href="groups/index/1">กลุ่มบริหารทั่วไป</a></li>
	      <li><a href="groups/index/2">กลุ่มโรคติดต่อทางอาหารและน้ำ</a></li>
	      <li><a href="groups/index/3">กลุ่มโรคติดต่อที่ป้องกันได้ด้วยวัคซีน</a></li>
	      <li><a href="groups/index/4">กลุ่มโรคติดต่อระหว่างสัตว์และคน</a></li>
	      <li><a href="groups/index/5">กลุ่มโรคติดต่อระหว่างประเทศ</a></li>
	      <li><a href="groups/index/6">กลุ่มสื่อสารสาธารณะและภาคีเครือข่าย</a></li>
	      <li><a href="groups/index/7">กลุ่มยุทธศาสตร์และพัฒนาองค์กร</a></li>
	      <li><a href="groups/index/8">กลุ่มบริหารเวชภัณฑ์</a></li>
	      <li><a href="groups/index/9">ด่านควบคุมโรคติดต่อระหว่างประเทศ ท่าอากาศยานสุวรรณภูมิ</a></li>
	      <li><a href="groups/index/10">ด่านควบคุมโรคติดต่อระหว่างประเทศ ท่าเรือกรุงเทพฯ</a></li>
	      <li><a href="groups/index/11">กลุ่มปฏิบัติการเตรียมพร้อมตอบโต้ภาวะฉุกเฉินด้านการควบคุมโรคและภัยสุขภาพ</a></li>
	      <li><a href="groups/index/12">ศูนย์ประสานงานโครงการกวาดล้างโปลิโอและโรคหัดตามพันธะสัญญานานาชาติ</a></li>
	      <li><a href="groups/index/13">ที่ทำการแพทย์ตรวจคนเข้าเมืองแจ้งวัฒนะ</a></li>
	      <li><a href="groups/index/14">ที่ทำการแพทย์ตรวจคนเข้าเมืองสวนพลู</a></li>
	      <li><a href="groups/index/15">โครงการตามพระราชดำริฯ ควบคุมโรคหนอนพยาธิ</a></li>
	      <li><a href="groups/index/16">โครงการตามพระราชดำริฯ ด่านควบคุมโรคติดต่อระหว่างประเทศ ท่าอากาศยานดอนเมือง</a></li>
	      <li><a href="groups/index/17">โครงการศูนย์เด็กเล็กและโรงเรียนอนุบาลปลอดโรค</a></li>
	      <li><a href="groups/index/18">ศูนย์ช่วยอำนวยการ</a></li>
	    </ul>
	  </li>
	  <li><a target="_self" href="pages/contactus"><?php echo lang('contact')?></a></li>
