	...
	<ul id="drop-nav">
	  ...
	  <li><a target="_self" href="groups"><?php echo lang('structures')?></a>
	    <ul>
	      ...
	      <li><a href="groups/view/16">โครงการตามพระราชดำริฯ ด่านควบคุมโรคติดต่อระหว่างประเทศ ท่าอากาศยานดอนเมือง</a></li>
	      <li><a href="groups/view/17">โครงการศูนย์เด็กเล็กและโรงเรียนอนุบาลปลอดโรค</a></li>
